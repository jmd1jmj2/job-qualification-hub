    ...
    if (pasted) {
      if (!looksLikeRealPosting(pasted)) {
        return res.status(422).json({
          error: 'The job description available for this role is incomplete. Refresh the role from Daily Job Scout or paste the full job description before assessing.',
          stage: 'posting_validation',
          validatorVersion: VALIDATOR_VERSION
        });
      }
      req.body = { ...body, jobDescription: pasted, jobUrl: '' };
